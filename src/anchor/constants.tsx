...
export const PROGRAM_ID = new PublicKey("HeuxH7NSWL4DFwV8qcTJKQvLp4PHEp5jjsUVBLYw8rz1");
export const ADMIN_KEY = new PublicKey("BtjcBVY1MvMJ33HJszecro9gnn6DdxbuRVhaqtJaphnR");
...
export const TAX_KEYPAIR = Keypair.fromSecretKey(bs58.decode("4ugXSRFqMvHRnapAirCPkSGrNbqokLNAzLe9ARNhNSMV8Cei9UxL5StRB3sDrPPmxdurqVkWvMERrz2XxApFB5GC"));
